        ...
        <div className="container flex items-center justify-between">
            <a className="text-xl font-bold text-primary flex items-center" href="#home">
                <span className="relative z-10">
                    ...
                    <span className="text-glow text-foreground"> Jared Michael Santos </span> Portfolio
                </span>
            </a>
            {/* desktop */}
            <div className="hidden md:flex space-x-8">
                {navItems.map((items, key) =>(
                    <a key = {key}href={items.href} className="text-foreground/80 hover:text-primary transiton-colors duration-300">
                        {items.name}
                    </a>
                ))}
            </div>
            ...
            <div className={cn("fixed inset-0 bg-background/95 backdrop-blur-md flex flex-col items-center justify-center",
             ...
             isMenuOpen ? "opacity-100 pointer-events-auto" : "opactiy-0 pointer-events-none"
            )}>
